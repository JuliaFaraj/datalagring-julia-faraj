        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ParticipantCode = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    OccasionCode = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CourseOccasionId = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CourseOccasions_OccasionCode",
                table: "CourseOccasions",
                column: "OccasionCode",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Enrollments_ParticipantId_CourseOccasionId",
                table: "Enrollments",
                columns: new[] { "ParticipantId", "CourseOccasionId" },
                unique: true);
